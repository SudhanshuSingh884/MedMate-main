...
class _TablePageState extends State<TablePage> {
  ...
  Future<void> _addData(
    ...
    await _database3.insert('my_table', {
      'cabinss': cabinss,
      'taken': taken,
      "titles": titles,
        ...
        child: Table(
          ...
          children: [
            TableRow(children: [
              ...
              TableCell(child: Center(child: Text('Pill Name'))),
            ...
            for (final row in _data)
              TableRow(children: [
                TableCell(
                    child:
                        Center(child: Text(row['datesofalarms'].toString()))),
                TableCell(child: Center(child: Text(row['titles'].toString()))),
                TableCell(
                    child: Center(child: Text(row['cabinss'].toString()))),
                TableCell(
                    child: Container(
